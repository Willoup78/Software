...
static int8_t SmartVision_V3_Init     (void);
static int8_t SmartVision_V3_DeInit   (void);
static int8_t SmartVision_V3_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t SmartVision_V3_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_SmartVision_V3_fops = 
{
  SmartVision_V3_Init,
  SmartVision_V3_DeInit,
  SmartVision_V3_Control,
  SmartVision_V3_Receive
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t SmartVision_V3_Receive(uint8_t* Buf, uint32_t *Len)
{
